  ...
  return (
    <div className="border border-slate-200 rounded-md overflow-hidden bg-white">
      ...
      <div
        ...
        onInput={emitChange}
        onBlur={emitChange}
        className="min-h-[calc(180px_+_1cm)] max-h-[calc(320px_+_1cm)] overflow-y-auto px-2.5 py-2 text-[12px] text-slate-900 leading-relaxed outline-none prose prose-sm max-w-none [&_img]:max-w-full [&_img]:h-auto"
      />
    </div>
  );
};
