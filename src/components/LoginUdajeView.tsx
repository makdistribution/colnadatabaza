...
export const LoginUdajeView: React.FC<LoginUdajeViewProps> = ({
  ...
  return (
    <div className="space-y-6 my-4">
      {/* Banner */}
      <div className="bg-white border-2 border-slate-400 p-4 rounded-xl flex items-center justify-between shadow-xs">
      ...
      {/* Category I Table */}
      <div className="bg-white border-2 border-slate-400 rounded-xl shadow-xs overflow-hidden">
        <div className="bg-slate-50 px-4 py-3 border-b-2 border-slate-400 flex items-center justify-between">
                  ...
                  <tr key={r.id} className={`transition-colors hover:bg-blue-50/50 ${idx % 2 === 1 ? 'bg-slate-50/40' : 'bg-white'}`}>
                    ...
                    <td className="p-2.5 border-r-2 border-slate-400">
                      <a
                        ...
                        className="text-blue-600 hover:underline flex items-center gap-1 max-w-[220px] truncate font-medium"
                      >
                        <span>{r.odkaz}</span>
                  ...
                  <tr key={r.id} className={`transition-colors hover:bg-blue-50/50 ${idx % 2 === 1 ? 'bg-slate-50/40' : 'bg-white'}`}>
                    ...
                    <td className="p-2.5 border-r-2 border-slate-400">
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-blue-600 hover:underline flex items-center gap-1 max-w-[240px] truncate font-medium"
                      >
                        <span>{r.odkaz}</span>
                        <ExternalLink className="w-3 h-3 text-blue-500 shrink-0" />
                      </a>
