        ...
        <div className="w-full flex flex-col md:flex-row items-center justify-between gap-3 text-xs">
          ...
          <div className="flex items-center justify-center md:justify-end gap-2 w-full md:w-auto">
            ...
            <button
              ...
              className="box-border w-[8.45rem] h-[2.125rem] shrink-0 bg-white border-2 border-[#000a2f] text-blue-950 font-bold text-xs sm:text-sm rounded-xl shadow-2xs hover:bg-slate-50 disabled:cursor-not-allowed cursor-pointer uppercase tracking-wide inline-flex items-center justify-center overflow-hidden"
